...
1. What would customers use if you didn't exist?
2. What's your unique capability?
3. What value does that capability enable?
4. Who cares most about that value?
5. What market context makes this obvious?
...
1. **Identify the decision type** — prioritization? positioning? team? validation?
2. **Surface the relevant framework** — don't lecture, apply it to their context
3. **Challenge conventional thinking** — if they're following an "obvious" path, check it against counterintuitive truths
4. **Ask the uncomfortable question** — what are they afraid to do? That's probably the answer.
