...
This skill draws on principles from legendary copywriters. For detailed techniques from each, see [references/legends.md](references/legends.md).
...
2. Deliver news
3. Arouse curiosity
4. Call out the audience

See [references/formulas.md](references/formulas.md) for proven headline templates.
...
- [ ] Is the headline benefit-driven or curiosity-inducing?
- [ ] Does the opening hook grab attention immediately?
- [ ] Is the copy specific (numbers, names, details)?
- [ ] Are all claims supported with proof?
...
- [references/legends.md](references/legends.md): Deep dives on each copywriter's techniques
- [references/formulas.md](references/formulas.md): Headline formulas, frameworks (AIDA, PAS, etc.)
- [references/examples.md](references/examples.md): Classic examples and swipe file
